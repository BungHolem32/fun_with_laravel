<?php
/**
 * It's a copy of Mobile_Detect.php that was created to ensure there won't be collisions between 
 * autoload and explicit requires in admittedly clumsy way.
