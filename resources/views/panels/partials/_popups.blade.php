...
<div class="modal {{ \App\Customer::get()->balance < 100 ? 'showen':'hidden' }}" id="formDepositModal" tabindex="-1" role="dialog" aria-labelledby="depositModalLabel" aria-hidden="true" style="outline: none; overflow-y: auto; top: 0px; height: 100%; width: 100%; display: none;">
    <div class="modal-dialog" style="border: none;">
        <div class="modal-content">
            <div class="modal-header depositTitle">
