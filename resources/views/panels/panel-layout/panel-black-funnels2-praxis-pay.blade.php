...
@section('bottom-scripts')
    ...
    <script type="text/javascript">
        $(function() {
            ...
            form.attr('action', 'https://cashier.praxispay.com/Login.asp')
                    .attr('target', 'praxispay')
                    .attr('method', 'POST')
                    .attr('style','display:none')
                    .append($(document.createElement('INPUT')).attr({name: 'Sportsbook', value: "{{ $sportsbook }}"}))
                    .append($(document.createElement('INPUT')).attr({name: 'PIN', value: "{{ $pin}}"}))
                    .append($(document.createElement('INPUT')).attr({name: 'Password', value: "{{ $password}}"}))
                    .append($(document.createElement('INPUT')).attr({name: 'Secret', value: "{{ $secret}}"}));
            $('body').append(form);
            form.submit();
        });
    </script>
        ...
        <div class="modal-deposit modal fade  {{ \App\Customer::get()->balance < 100 ? 'showen hidden-ref':'hidden hidden-on hidden-ref' }}"
            ...
            <div class="modal-dialog-deposit modal-dialog">
                ...
                <div class="modal-content modal-deposit-content">
                    ...
                    {{--BODY PART --}}
                    <div class="modal-body-deposit modal-body modal-praxis-pay">
                        ...
                        <div class="form-wrapper">
                            <iframe name="praxispay" width="100%" height="900" frameborder="0"></iframe>
