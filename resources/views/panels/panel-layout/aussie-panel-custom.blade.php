                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-4 col-md-4 col-sm-4 text-align-center" id="activationStatus">
                                                ...
                                                <p class="alert alert-success" style="display: none;">
                                                    {{ $page->title_h1 }} searching for new winning trades...<i class="fa fa-cog fa-spin"></i>
                                                </p>
                                                <div style="display: none;">
                                                    <p class="alert alert-warning">
                                                        Click "ON" to activate your {{ $page->title_h1 }} Trading System.
                                                    </p>
                                                </div>
                                            </div>
                                    ...
                                    <div class="widget">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="text-center">
                                                <div class="subsectionheader panel-sec-bg-color" id="runningPositionsHeader">@ln(Open Trades) <i class="getLoading fa fa-refresh fa-spin"></i></div>
                                            ...
                                            <div class="table-margin text-center">
                                                <div id="positionsHistoryTableTitle" class="subsectionheader panel-sec-bg-color">@ln(Trades History) <i class="getLoading fa fa-refresh fa-spin"></i></div>
