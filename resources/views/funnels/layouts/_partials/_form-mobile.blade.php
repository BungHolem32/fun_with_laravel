    ...
    @foreach($fields as $field)
        ...
        @elseif($field[0] == 'phone')
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 field phoneFields">
                <input type="phone" id="prefix" class="col-lg-3 col-md-3 col-sm-3 col-xs-2" name="prefix" required="required" data-cip-id="prefix" />
                <input type="{{ $field[0] }}" id="{{ $field[1] }}" class="col-lg-9 col-md-9 col-sm-9 col-xs-10" name="{{ $field[1] }}" required="required" placeholder="{{ \App\Languages::getTrans($field[2]) }}" data-cip-id="{{ $field[1] }}">
            </div>
        ...
        @elseif($field[0] == 'submit')
            ...
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 field">
                ...
                @endif
                <input type="{{ $field[0] }}" id="{{ $field[1] }}" class="form-control col-md-10 col-xs-12" name="{{ $field[1] }}" value="{{ \App\Languages::getTrans($field[2]) }}" data-cip-id="{{ $field[1] }}">
            </div>
        @endif
    @endforeach
</div>
