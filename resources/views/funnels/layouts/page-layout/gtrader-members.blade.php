@section('head')
    {!! $page->appendAsset(url('/css/gtrader/bootstrap.min.css')) !!}
    {!! $page->appendAsset(url('/css/gtrader/bootstrap-theme.min.css')) !!}
    ...
    {!! $page->appendAsset(url('/css/gtrader/form.css')) !!}
...
@section('bottom-scripts')
    ...
    {!! $page->appendAsset(url('/js/gtrader/form.js')) !!}
...
@section('page-layout')
    <div class="container main-content">
        <div id="content_area" class="">
            <div style='background:#fbfbfb;border-top-width:px;border-top-style:solid;border-top-color:;border-bottom-width:px;border-bottom-style:solid;border-bottom-color:;'
                        ...
                        <div class="element-container cf" data-style="" id="le_body_row_1_col_1_el_1">
                            <div class="element">
                                <div class="image-caption"
                                    ...
                                    <img alt="" src="/img/gtrader/logo1.png" border="0" class="full-width"/>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div style='background:#263238;padding-top:25px;padding-bottom:25px;border-top-width:7px;border-top-style:solid;border-top-color:;border-bottom-width:px;border-bottom-style:solid;border-bottom-color:;'
                 ...
                 data-style="eyJiYWNrZ3JvdW5kQ29sb3JTdGFydCI6IiMyNjMyMzgiLCJwYWRkaW5nVG9wIjoiMjUiLCJwYWRkaW5nQm90dG9tIjoiMjUiLCJib3JkZXJUb3BXaWR0aCI6IjciLCJib3JkZXJUb3BDb2xvciI6IiIsImJvcmRlckJvdHRvbVdpZHRoIjoiIiwiYm9yZGVyQm90dG9tQ29sb3IiOiIiLCJhZGRvbiI6e319">
                <div class="fixed-width">
                    <div class="one-column column cols" id="le_body_row_2_col_1">
                        <div class="element-container cf roboto-500 no-margin"
                            ...
                            <div class="element"><h2
                                        style='font-size:27px;font-family:"Lato", sans-serif;font-weight:bold;color:#ffffff;text-align:center;line-height:42px;margin-top:10px;'>
                                    Let The BIGGEST Search Engine in The World Do The Hard Work For YOU...</h2></div>
                        </div>
                        <div class="element-container cf roboto-500" data-style="eyJhZHZhbmNlZENsYXNzIjoicm9ib3RvLTUwMCJ9"
                             id="le_body_row_2_col_1_el_2">
                            <div class="element"><h2
                                        style='font-size:44px;font-family:"Lato", sans-serif;font-style:normal;font-weight:300;color:#ffffff;text-align:center;line-height:48px;margin-bottom:30px;'>
                                    Get <span style="text-decoration: underline;"><strong>FULL ACCESS</strong></span> To The
                                    Software<br/>
                                    that Makes <span style="color: #f25565;"><strong>$4,300</strong> </span>Every Single DAY
                                </h2></div>
                        </div>
                    </div>
                </div>
            </div>
            <div style='padding-bottom:10px;border-top-width:px;border-top-style:solid;border-top-color:;border-bottom-width:px;border-bottom-style:solid;border-bottom-color:;'
                 class="row three-columns cf ui-sortable" id="le_body_row_3"
                 data-style="eyJwYWRkaW5nQm90dG9tIjoiMTAiLCJib3JkZXJUb3BXaWR0aCI6IiIsImJvcmRlclRvcENvbG9yIjoiIiwiYm9yZGVyQm90dG9tV2lkdGgiOiIiLCJib3JkZXJCb3R0b21Db2xvciI6IiIsImFkZG9uIjp7fX0=">
                <div class="fixed-width">
                    <div class="two-thirds column cols" id="le_body_row_3_col_1">
                    ...
                    <div class="one-third column cols narrow" id="le_body_row_3_col_2">
                        <div class="element-container cf" data-style="" id="le_body_row_3_col_2_el_1">
                            <div class="element">
                                <h2 style='font-size:44px;color:#e65100;text-align:center;'>REGISTER NOW</h2>
                            </div>
                        </div>
                        <div class="element-container cf" data-style="" id="le_body_row_3_col_2_el_2">
                            <div class="element">
                                <div class="styled-hr hr-style-3">
                                    <img src="/img/gtrader/ornament-3.png"
                                         alt="shadow-ornament" width="79" height="27" class="ornament"/>
                                    <hr/>
                                </div>
                            </div>
                        </div>
                        <div class="element-container cf" data-style="" id="le_body_row_3_col_2_el_3">
                            <div class="element">
                                <div class="op-custom-html-block">
                                    <div id="form-element" class="boostforms theme-undefined">
            ...
            <div style='background:#F5F5F5;padding-top:35px;padding-bottom:35px;border-top-width:px;border-top-style:solid;border-top-color:;border-bottom-width:px;border-bottom-style:solid;border-bottom-color:;'
                 class="row one-column cf ui-sortable" id="le_body_row_12"
                 data-style="eyJiYWNrZ3JvdW5kQ29sb3JTdGFydCI6IiNGNUY1RjUiLCJwYWRkaW5nVG9wIjoiMzUiLCJwYWRkaW5nQm90dG9tIjoiMzUiLCJib3JkZXJUb3BXaWR0aCI6IiIsImJvcmRlclRvcENvbG9yIjoiIiwiYm9yZGVyQm90dG9tV2lkdGgiOiIiLCJib3JkZXJCb3R0b21Db2xvciI6IiIsImFkZG9uIjp7fX0=">
                <div class="fixed-width">
                    <div class="one-column column cols" id="le_body_row_12_col_1">
                        <div class="element-container cf roboto-500" data-style="eyJhZHZhbmNlZENsYXNzIjoicm9ib3RvLTUwMCJ9"
                             id="le_body_row_12_col_1_el_1">
                            <div class="element"><h2
                                        style='font-size:90px;font-family:"Lato", sans-serif !important;font-style:normal;font-weight:300;color:#212121;text-align:center;line-height:42px;margin-bottom:30px;'>
                                    HELP &amp; SUPPORT 24/7</h2></div>
                        </div>
