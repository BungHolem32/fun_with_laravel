@section('head')
    <meta name="viewport" content="width=390px, initial-scale=.7, maximum-scale=.7"/>
    <link rel="stylesheet" href="/css/rb-options-n-background/style-{{Request::local()->dir}}.css">
...
@section('page-layout')
    ...
    <div class="wrapper">
        ...
        <section class="top-elem">
            <div class="container">
                <div class="row strip-top-logo-wrapper">
                    <img src="/img/rboptions-n-background/logo.png" alt="" class="img-responsive center-block">
                    <div class="img">
                        @if(isMongoNotEmpty($page->switches->stamp))
                            <img src="{{$page->switches->stamp}}" alt="" class="img-responsive">
                        @else
                            <img src="/img/rboptions-n-background/en/icon.png" alt="" class="img-responsive">
                        @endif
                    </div>
                </div>
                    ...
                    <div class="content">
                        ...
                        <div class="prop-wrapper container">
                            <div class="col-md-4 col-sm-4 col-xs-4 text-center">
                                <p class="text-capitalize"><img src="/img/rboptions-n-background/v.png" alt="">
                                    @ln(same day withdrawal)</p>
                            </div>

                            <div class="col-md-4 col-sm-4 col-xs-4 text-center">
                                <p class="text-capitalize">
                                    <img src="/img/rboptions-n-background/v.png" alt="">
                                    @ln(bonus) 100%
                                </p>
                            </div>
                            ...
                            {{--<div class="col-md-4 col-sm-4 col-xs-4 text-center">--}}
                            {{--<p class="text-capitalize">--}}
                            {{--<img src="/img/rboptions-n-background/v.png" alt=""> @ln({{$prop}}) {{$key == 1? '100%' :''}}--}}
                            {{--</p>--}}
                            {{--</div>--}}
                            {{--@endforeach--}}
        ...
        <section class="bottom-arrow container">
            <img src="/img/rboptions-n-background/arrow.png" alt="">
        </section>
        ...
        <section class="bottom-signs">
            <div class="container">
                <img src="/img/rboptions-n-background/icons.png" alt="" class="img-responsive center-block">
            </div>
        </section>
