@section('head')
    ...
    <!-- Startup CSS -->
    {!! $page->appendAsset(url('/css/aussie/style-uk.css')) !!}
    <!--[if lt IE 9]>
...
@section('bottom-scripts')
    <script language="javascript">
        ...
        var loadingMsg = '<div class="loading"><img src="/img/aussie-uk/loadingBL2.gif" alt=""><div class="loading-text"> Registration is in progress.. </div></div>';
    </script>
    @com('funnel_scripts')
...
@section('page-layout')
    <img src="/img/aussie-uk/callout.png" style="position:fixed; top:0; right:0">
    <div class="staticsignup" id="staticsignup">
        <center>
            <img src="/img/aussie-uk/sloo.png" width="180" style="padding-bottom:10px;padding-left:5px;">
        </center>
    </div>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" background="/img/aussie-uk/bg.png">
        <tr>
            <td height="134" valign="top"><center>
                    <a name="startnow"></a><img src="/img/aussie-uk/tit.png" width="970" height="108" style="padding-bottom:-10px;">
                </center></td>
        </tr>
    </table>
    <table width="100%" border="0" cellspacing="0" cellpadding="0" style="background-color:#f3f3f3;" background="/img/aussie-uk/ausbg.jpg">
        <tr>
            <td><center>
                    <p>
                    ...
                    <p style="font-family: 'Cabin', sans-serif;">Enter your email below to gain instant <br>
                        free access to the Oxford Method system</p>
                    <br>
                    ...
                    @endif
                    <input type="submit" src="/img/aussie-uk/buttonfree.png" style="outline: none; width:200px;" />
                    {!! Form::close() !!}

                    <br>
                    <img src="/img/aussie-uk/certs.png" width="250">
                </center></td>
        </tr>
    </table>
    <p> </p>
    ...
    <Center>
        <a name="aboutme"></a> <a class="fancybox" rel="group" href="/img/aussie-uk/guarantee.png"><img src="/img/aussie-uk/hey.png" alt="" /></a>
    </Center>
    <br>
    <br>
    ...
    <p>&nbsp;</p>
    <Center>
        <p><img src="/img/aussie-uk/iphone.png" width="921" height="523"><br>
            <img src="/img/aussie-uk/face.png" width="921" height="434"></p>
        ...
        <table id="social"  width="921" border="0" cellspacing="0" cellpadding="0" background="/img/aussie-uk/blank.png">
            <tr>
                <td height="521"><center>
                        <table width="100" border="0">
                            <tr>
                                <td><center>
                                        <img class="fwimg" src="/img/aussie-uk/fb.png" width="250"> <br>
                                        <br>
                                ...
                                <td><center>
                                        <img class="twimg" src="/img/aussie-uk/twt.png" width="250"><br>
                                        <br>
        ...
        <p>&nbsp;</p>
        <table width="921" border="0" cellspacing="0" cellpadding="0" background="/img/aussie-uk/blank.png">
            <tr>
                        ...
                        <div class="tradessect">
                            <table class="table table-striped table-bordered shadowed table-hover" id="positionsHistoryTable" style="background-color:#FFF;" bgcolor="#FFFFFF" width="820px">
                                ...
                                <tr>
                                    ...
                                    <th background="/img/aussie-uk/topb.png"><font style="font-family: 'Cabin', sans-serif;; color:#000 !important;"><center>Results</center></font></th>
                                </tr>
                                </thead>
                                <tbody id="trades">
        ...
        <tr>
            <td height="50" bgcolor="#1e387b" align="center">
                <table class="footer" width="880" border="0" cellspacing="0" cellpadding="0" style="color:#cedbff;">
                    <tr>
                        <td align="left"> Copyright 2016 Oxford Method. All Right Reserved. </td>
                        <td align="right">
