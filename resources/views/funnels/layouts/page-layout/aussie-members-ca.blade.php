@section('head')
    ...
    <!-- Startup CSS -->
    {!! $page->appendAsset(url('/css/aussie/style-ca.css')) !!}
...
@section('bottom-scripts')
        <script language="javascript">
            var loadingMsg = '<div class="loading"><img src="/img/aussie-ca/loadingBL2.gif" alt=""><div class="loading-text"> Registration is in progress.. </div></div>';
...
@section('page-layout')
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" background="/img/aussie-ca/bg.png">
        <tbody><tr>
            <td height="134" valign="top"><center>
                <img src="/img/aussie-ca/tit.png" width="970" height="108" style="padding-bottom:-10px;">
            </center></td>
        </tr>
        </tbody></table>
    <table width="100%" border="0" cellspacing="0" cellpadding="0" style="background-color:#f3f3f3;" background="../ausbg.jpg">
        <tbody><tr>
            <td><center>
                ...
                <p>&nbsp;</p>
                <div class="highlight">
                    <div class="section-title"> <a name="start"></a><img src="/img/aussie-ca/3step.png" width="900" height="295"><br>
                        <p>&nbsp;</p>
                        <p>&nbsp;</p>
                    ...
                    <div class="container">
                        <div style="height:300px; width:1070px; background: #FFF;padding: 15px; border-radius:10px;box-shadow: 0px 0px 25px #999;">
                            <div style="float:left; width:33%; text-align: center;vertical-align:middle"><img src="/img/aussie-ca/man.png" width="250" style="padding-top:20px;"></div>
                            <div style="float:left; width:33%; text-align: center;vertical-align:middle;padding-top: 20px;">
                                <div class="plan-features">
                                    <p>&nbsp;</p>
                                    <p><span style="font-size:19px; font-family: 'Cabin', sans-serif;">Ryan Wolfe - Maple Method Founder<br>
                  <strong>Profit To Date: <u>$2,187,612.00</u> </strong></span><br>
                            ...
                            <center style="padding-top:35px;">
                                <img src="/img/aussie-ca/vta.png" width="200" height="200">
                            </center>
                            <div style="float:left; width:33%; text-align: center;vertical-align:middle;padding-top: 20px;">
                        ...
                        <div style="height:300px; width:1070px; background: #FFF;padding: 15px; border-radius:10px;box-shadow: 0px 0px 25px #999;margin-bottom: 30px;">
                            <div style="float:left; width:33%; text-align: center;vertical-align:middle"><img src="/img/aussie-ca/p1.png" alt="" width="237" height="237" style="margin-top:16px"></div>
                            <div style="float:left; width:33%; text-align: center;vertical-align:middle;padding-top: 20px;">
                                <div class="plan-features">
                                    <p>&nbsp;</p>
                                    <p><span style="font-size:19px; font-family: 'Cabin', sans-serif;">FIONNA MAGUIRE  <br>
                  ...
                  <strong>Profit To Date: <u>$212,450.00</u> </strong></span><br>
                        ...
                        <div style="height:300px; width:1070px; background: #FFF;padding: 15px; border-radius:10px;box-shadow: 0px 0px 25px #999;margin-bottom: 30px;">
                            <div style="float:left; width:33%; text-align: center;vertical-align:middle"><img src="/img/aussie-ca/p2.png" alt="" width="237" height="237" style="margin-top:16px"></div>
                            <div style="float:left; width:33%; text-align: center;vertical-align:middle;padding-top: 20px;">
                                <div class="plan-features">
                                    <p>&nbsp;</p>
                                    <p><span style="font-size:19px; font-family: 'Cabin', sans-serif;">JESSE BROWNE <br>
                  ...
                  <strong>Profit To Date: <u>$196,201.00</u> </strong></span><br>
                        ...
                        <div style="height:300px; width:1070px; background: #FFF;padding: 15px; border-radius:10px;box-shadow: 0px 0px 25px #999;margin-bottom: 30px;">
                            <div style="float:left; width:33%; text-align: center;vertical-align:middle"><img src="/img/aussie-ca/p3.png" alt="" width="237" height="237" style="margin-top:16px"></div>
                            <div style="float:left; width:33%; text-align: center;vertical-align:middle;padding-top: 20px;">
                                <div class="plan-features">
                                    <p>&nbsp;</p>
                                    <p><span style="font-size:19px; font-family: 'Cabin', sans-serif;">DIONN PHILLIPS<br>
                ...
                <table id="social" width="921" border="0" cellspacing="0" cellpadding="0" background="/img/aussie-ca/blank.png">
                    <tbody><tr>
                        <td height="521"> <center><table width="100" border="0">
                            <tbody><tr>
                                <td><center>
                                    <img class="fwimg" src="/img/aussie-ca/fb.png" width="250"> <br>
                                    <br>
                                    ...
                                    <script>
                                        ...
                                        */
                                        ...
                                        var nm = ["Brandon","Wyatt","Andrew","Jennifer","Charles","Shelby","Michael","Kurt",  "Bob","Stuart","Frank","Kristen","Tina","James","Amber","Marian"];
                                        var data = [
                                            "I love how simple it was to make $800 in 45 minutes!",
                                            "I LOVE the <b class='p-nickname'>Maple Method</b> the ONLY system! I just wish you’d tell fewer people, so I could keep the secret all to myself.",
                                            "I can’t wait until my withdrawal hit my bank account. 10 figure profits within one week!",
                                            "I’ve made $3500 today, and it’s hours before quitting time. <b class='p-nickname'>Maple Method</b> is the best!",
                                            "This system is crazy! Every day I keep raking in more money with the <b class='p-nickname'>Maple Method</b>.",
                                            "I just started, and I’m already hooked. I made $$5500 my first day!",
                                            "I can’t say thank you enough for everything the <b class='p-nickname'>Maple Method</b> support team has done for me ! You’ve really helped me out, guys.",
                                            "I’m glad I finally found a system that works. No more scams for me! I made over $500 on my first trade.",
                                            "@Maplemethod Already up over $3800 and the day is still young",
                                            "Just made $868.44 in a single trade @Maplemethod",
                                            "At last a legit binary system @Maplemethod",
                                            "Holy crap, this is amazing, I've made $7,891.32 on my very first day using the verified trader system @Maplemethod #system #binary #amazing",
                                            "At last a legit binary system @Maplemethod",
                                            "@Maplemethod Already up over $3800 and the day is still young",
                                            "Holy crap, this is amazing, I've made $7,891.32 on my very first day using the verified trader system @Maplemethod #system #binary #amazing",
                                            "Wow this might sound cheesy but I LOVE you guys @Maplemethod the ONLY system u need for making money online #makemoney #Maplemethod #awesome",
                                        ];
                                ...
                                <td><center>
                                    <img class="twimg" src="/img/aussie-ca/twt.png" width="250"><br>
                                    <br>
                                    ...
                                    <script>
                                        ...
                                        var data = [
                                            ...
                                            "WTF.... Thank You This thing is awesome @<b class='p-nickname'>maplemethod</b>"];
...
*/
                ...
                <center>
                    ...
                    <p>&nbsp;</p>
                    <table width="921" border="0" cellspacing="0" cellpadding="0" background="/img/aussie-ca/blank.png">
                        <tbody><tr>
                                ...
                                <div class="tradessect">
                                    <table class="table table-striped table-bordered shadowed table-hover" id="positionsHistoryTable" style="background-color:#FFF;" bgcolor="#FFFFFF" width="820px">
                                        ...
                                        <tr>
                                            ...
                                            <th background="/img/aussie-ca/topb.png"><font style="font-family: 'Cabin', sans-serif;; color:#000 !important;"><center>Results</center></font></th>
                                        </tr>
                                        </thead>
                                        <tbody id="trades">
                            ...
                            <tbody><tr>
                                <td height="50" bgcolor="#1e387b" align="center">
                                    <table class="footer" width="880" border="0" cellspacing="0" cellpadding="0" style="color:#cedbff;">
                                        ...
                                        <tr>
                                            <td align="left">
                                                Copyright 2016 Maple Method. All Right Reserved.
                                            </td>
                                            <td align="right">
