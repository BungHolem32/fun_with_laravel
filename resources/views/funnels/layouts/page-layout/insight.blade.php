...
@section('bottom-scripts')
    @if(Request::get('epass')!=532)
        ...
        <script language="javascript" src="/js/insight/custom.js"></script>
    @endif
@append