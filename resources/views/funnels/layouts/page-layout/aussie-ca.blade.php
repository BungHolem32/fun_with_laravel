...
@section('page-layout')
    <img src="/img/aussie-ca/callout.png" style="position:fixed; top:0; right:0">
    <div class="staticsignup" id="staticsignup">
        <center>
            <img src="/img/aussie-ca/sloo.png" width="180" style="padding-bottom:10px;padding-left:5px;">
        </center>
    </div>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" background="/img/aussie-ca/bg.png">
        <tr>
            <td height="134" valign="top"><center>
                    <a name="startnow"></a><img src="/img/aussie-ca/tit.png" width="970" height="108" style="padding-bottom:-10px;">
                </center></td>
        </tr>
    </table>
    <table width="100%" border="0" cellspacing="0" cellpadding="0" style="background-color:#f3f3f3;" background="/img/aussie-ca/ausbg.jpg">
        <tr>
            <td><center>
                    <p>
                    ...
                    @endif
                    <input type="submit" src="/img/aussie-ca/buttonfree.png" style="outline: none; width:200px;" />
                    {!! Form::close() !!}

                    <br>
                    <img src="/img/aussie-ca/certs.png" width="250">
                </center></td>
        </tr>
    </table>
    <p> </p>
    ...
    <Center>
        <a name="aboutme"></a> <a class="fancybox" rel="group" href="/img/aussie-ca/guarantee.png"><img src="/img/aussie-ca/hey.png" alt="" /></a>
    </Center>
    <br>
    <br>
    ...
    <p>&nbsp;</p>
    <Center>
        <p><img src="/img/aussie-ca/iphone.png" width="921" height="523"><br>
            <img src="/img/aussie-ca/face.png" width="921" height="434"></p>
        ...
        <tr>
            <td height="50" bgcolor="#1e387b" align="center">
                    <table class="footer" width="880" border="0" cellspacing="0" cellpadding="0" style="color:#cedbff;">
                        <tr>
                            <td align="left"> Copyright 2016 Maple Method. All Right Reserved. </td>
                            <td align="right">
