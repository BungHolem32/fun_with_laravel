    ...
    <div id="wrapper">
        <header id="header">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <div class="logo"><a href="#"><img src="/img/binarystocks/Skyline-LogoSVG-forwhitebg.svg"
        ...
        <main id="main">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <h1>
                            <mark>Stocks & Binary Options</mark>
                            Make A Great Combination <span>Find The Winning Trading Solution</span></h1>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <ul class="pay-list">
                            <li><a href="#"><img src="/img/binarystocks/pay-icon01.png" height="33" width="55"
                                                 alt="image description"></a></li>
                            <li><a href="#"><img src="/img/binarystocks/pay-icon02.png" height="33" width="55"
                                                 alt="image description"></a></li>
                            <li><a href="#"><img src="/img/binarystocks/pay-icon03.png" height="33" width="55"
                                                 alt="image description"></a></li>
                            <li><a href="#"><img src="/img/binarystocks/pay-icon04.png" height="33" width="55"
                                                 alt="image description"></a></li>
                            <li><a href="#"><img src="/img/binarystocks/pay-icon05.png" height="33" width="55"
                                                 alt="image description"></a></li>
                            <li><a href="#"><img src="/img/binarystocks/pay-icon06.png" height="33" width="55"
                                                 alt="image description"></a></li>
                        </ul>
                    </div>
                </div>
