    ...
    <div id="top-panel-cover">
        <div id="top-panel" class="row">
            <div id="account-details">
                ...
                <div class="getLoading" style="display:none;"><i class="fa fa-refresh fa-spin"></i></div>
            </div>
                                    ...
                                    <div class="widget">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class=" text-center">
                                                <h3 class="subsectionheader" id="runningPositionsHeader">Aussie Method Open Trades</h3>
                                                ...
                                                <div class="getLoading" style="display:none;"></div>
                                            </div>
