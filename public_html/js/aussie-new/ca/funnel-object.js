(function ( $ ) {
    ...
    var funnelControll = {
        ...
        questions: [ 'What is the Maple Method?', 'How much money can I make with this software?', 'How long does each trade last?', 'Do I need to use my credit card when I signup? ',
            'Does your software work with Mac computers?', 'I don\'t have much free time - Is the Maple Method really automated?', 'How easy is it to use the software? ',
            'What about customer support?' ],
        answers  : [ 'The Maple Method is a 100% FREE software that will trade on the binary options markets with just 1 click! It\'s fully automated and places the winning trades for you! ',
            ...
            'away, no more waiting for long periods of time.', 'NO WAY. The Maple Method App is 100% FREE. You will NOT be asked for your credit card or paypal or bank information when you download the Maple Method System! ' +
