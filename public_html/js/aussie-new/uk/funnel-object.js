...
<<<<<<< HEAD
        questions: [ 'What is the The Oxford Method?', 'How much money can I make with this software?', 'How long does each trade last??', 'Do I need to use my credit card when I signup?',
            'Does your software work with Mac computers?', 'I don\'t have much free time - Is the The Oxford Method really automated?', 'How easy is it to use the software?',
            'What about customer support?' ],
        answers  : [ 'The The Oxford Method is a 100% FREE software that will trade on the binary options markets with just 1 click! It\'s fully automated and places the winning trades for you!',
            ...
            'away, no more waiting for long periods of time.', 'NO WAY. The The Oxford Method App is 100% FREE. You will NOT be asked for your credit card or paypal or bank information when you download the The Oxford Method System!' +
=======
        questions: [ 'What is the Oxford Method?', 'How much money can I make with this software?', 'How long does each trade last??', 'Do I need to use my credit card when I signup?',
            'Does your software work with Mac computers?', 'I don\'t have much free time - Is the Oxford Method really automated?', 'How easy is it to use the software?',
            'What about customer support?' ],
        answers  : [ 'The Oxford Method is a 100% FREE software that will trade on the binary options markets with just 1 click! It\'s fully automated and places the winning trades for you!',
            'To put it in short, there\'s no limit. To put it more technically, it really depends on how much money you fund your account with. Most of our members fund their account with ' +
            '$300, and make about $800-1000 daily. Those who fund their account with $1,000 or over make over $2,500 per day!', 'Anywhere from a minute to an hour. So you will see your profits right' +
            'away, no more waiting for long periods of time.', 'NO WAY. The Oxford Method App is 100% FREE. You will NOT be asked for your credit card or paypal or bank information when you download the Oxford Method System!' +
...
<<<<<<< HEAD
                data         : [ "Wow this might sound cheesy but I LOVE you guys <b class='p-nickname'>The Oxford Method</b> the ONLY system u need for making money online makemoney The Oxford Method awesome",
                    "How long until the money hits my account from my broker account? <b class='p-nickname'>The Oxford Method</b> Just withdrawn 5 figures 5figureprofits profits awesome",
                    "This is like printing money...For Real Take it off the market <b class='p-nickname'>The Oxford Method</b> dont want others getting their hands on this selfish",
                    "Celebrating another profitable day using the <b class='p-nickname'>The Oxford Method</b> not had a losing day yet",
                    "Brilliant stuff, u guys are the bomb <b class='p-nickname'>The Oxford Method</b> First trade today and just made $389.11 profit moreprofits The Oxford Method",
                    "Awesome system, made over $2000 in my first 2 hours using the <b class='p-nickname'>The Oxford Method</b> system",
                    "Thank You Thank You Thank You <b class='p-nickname'>The Oxford Method</b>",
                    "Holy crap, this is amazing, I've made $7,891.32 on my very first day using the verified trader system <b class='p-nickname'>The Oxford Method</b> system binary amazing",
                    "<b class='p-nickname'>The Oxford Method</b> Sup guys, super sick system u got here",
                    "Deposited $250 <b class='p-nickname'>The Oxford Method</b> with the verified trader system now my account sits at over $30k in just a week Lovethis millionairestatus",
                    "At last a legit binary system <b class='p-nickname'>The Oxford Method</b>",
                    "Can't thank you guys enough <b class='p-nickname'>The Oxford Method</b> been scammed so many times before but this really is the real deal",
                    "Thanks to <b class='p-nickname'>The Oxford Method</b> for finally making a binary system that really works amazing makemoney",
                    "<b class='p-nickname'>The Oxford Method</b> Already up over $3800 and the day is still young",
                    "Just made $868.44 in a single trade <b class='p-nickname'>The Oxford Method</b>",
                    "<b class='p-nickname'>The Oxford Method</b> Just made $918.88 in 34 minutes",
                    "what is happening?? My account now sits at $23,891.44 I only deposited $300 4 days ago, this is insane <b class='p-nickname'>The Oxford Method</b>",
                    "Thanks support for solving my small problem, looking forward to making lots of cash with this cash thanks The Oxford Method support <b class='p-nickname'>The Oxford Method</b>",
                    "WTF.... Thank You This thing is awesome <b class='p-nickname'>The Oxford Method</b>" ],
=======
                data         : [ "Wow this might sound cheesy but I LOVE you guys <b class='p-nickname'>Oxford Method</b> the ONLY system u need for making money online makemoney Oxford Method awesome",
