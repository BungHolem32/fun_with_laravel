...
function mkChanges(times) {
    if (times == 11) {
        for (i = 1; i < 11; i++) {
            ...
            html = '<tr rv-class-success="position.status | eq won" rv-show="position.status | not_eq open" class="success">' +
...
//function AddTrade() {
//    for(var i=0;i<11;i+=rand_num(60,65))
//    {
//        //alert(i);
//        var p = rand_num(1,100);
//        p=p%2;
...
//        profit+=payout;
//        var name=names[rand_num(0,names.length)];
//        html='<tr rv-class-success="position.status | eq won" rv-show="position.status | not_eq open" class="success"><td rv-text="position.optionEndDate" align="center">' +
//            '<font style="font-family: \'Cabin\', sans-serif;"><span style="color:#1e387b; font-size:14px; font-weight:bold">'+name+'</span> just won a trade... </font>' +
//            '</td><td class="payoutwon" align="center"><font style="font-family: \'Cabin\', sans-serif !important; font-size:16px; font-weight:bold">$ '+numberCom(payout)+
//            '</font></td><td rv-text="position.optionEndDate" align="center"><font style="font-family: \'Cabin\', sans-serif;">'+getDateTime(i)+
//            '</font></td><td align="center"><span rv-text="position.name"><font style="font-family: \'Cabin\', sans-serif;">'+xasset+
//            '</span></font></td><td align="center"><span rv-text="position.status | capitalize" rv-class-label-success="position.status | eq won" rv-class-label-danger="position.status | eq lost" rv-class-label-info="position.status | tie_or_sold"><img src="/img/aussie/bluetick.png" height="20px"></span></td></tr>';
//        $('#trades').append(html);
//    }
//}
//AddTrade();
