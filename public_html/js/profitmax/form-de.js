$(document).ready(function () {
    ...
    $('#submit').attr({'value': 'KOMPLETE REGISTRIERUNG'}).removeClass().addClass('btn btn-sm register-btn').parent().removeClass().addClass('form-group col-md-12 submit-button-group');
});