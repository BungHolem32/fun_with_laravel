...
elixir(function(mix) {
    ...
    mix.less(['base-funnel-load-ltr.less'], 'public_html/css/rb-options-n-background/style-0.css')
        .less(['base-funnel-load-rtl.less'], 'public_html/css/rb-options-n-background/style-1.css');
